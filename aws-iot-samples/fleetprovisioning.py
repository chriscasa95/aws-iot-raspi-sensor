...
cmdUtils = command_line_utils.CommandLineUtils(
    "Fleet Provisioning - Provision device using either the keys or CSR."
)
...
cmdUtils.register_command(
    "template_name", "<str>", "The name of your provisioning template."
)
...
if __name__ == "__main__":
    ...
    print(
        "Connecting to {} with client ID '{}'...".format(
            ...
            cmdUtils.get_command("client_id"),
        )
    )
    ...
    try:
        ...
        if cmdUtils.get_command("csr") is None:
            ...
            (
                createcertificatefromcsr_subscribed_accepted_future,
                _,
            ...
            (
                createcertificatefromcsr_subscribed_rejected_future,
                _,
        ...
        registerthing_subscription_request = (
            iotidentity.RegisterThingSubscriptionRequest(
                template_name=cmdUtils.get_command_required("template_name")
            )
        )
